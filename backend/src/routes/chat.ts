...
// Accept chat request
router.post('/request/:id/accept', authMiddleware, async (req: any, res) => {
  try {
...
// Deny chat request
router.post('/request/:id/deny', authMiddleware, async (req: any, res) => {
  try {
    const request = await ChatRequest.findById(req.params.id);
...
// Get chat messages
router.get('/:chatId/messages', authMiddleware, async (req: any, res) => {
  try {
...
// Send message
router.post('/:chatId/messages', authMiddleware, async (req: any, res) => {
  try {
    const chat = await Chat.findById(req.params.chatId);
...
// Get unread count
router.get('/unread', authMiddleware, async (req: any, res) => {
  try {
